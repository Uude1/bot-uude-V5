...
var ExtendedClient = /** @class */ (function (_super) {
    ...
    ExtendedClient.prototype.connectDB = function () {
        ...
        try {
            ...
            console.error("Erro ao conectar ao MongoDB: ".concat(err).red);
        }
    };
    ExtendedClient.prototype.registerCommands = function (commands) {
        var _a;
    ...
    ExtendedClient.prototype.registerModules = function () {
        ...
        fs_1["default"].readdirSync(commandsPath).forEach(function (local) {
            fs_1["default"].readdirSync(commandsPath + "/".concat(local, "/")).filter(fileCondition).forEach(function (fileName) { return __awaiter(_this, void 0, void 0, function () {
                var command, name, buttons, selects, modals;
                var _this = this;
                var _a;
                return __generator(this, function (_b) {
                    var _c;
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (_c = "../commands/".concat(local, "/").concat(fileName), Promise.resolve().then(function () { return require(_c); }))];
                        case 1:
                            command = (_a = (_b.sent())) === null || _a === void 0 ? void 0 : _a["default"];
                            name = command.name, buttons = command.buttons, selects = command.selects, modals = command.modals;
                            if (name) {
        ...
        this.on("ready", function () { return _this.registerCommands(slashCommands); });
    };
        ...
        fs_1["default"].readdirSync(eventsPath).forEach(function (local) {
            fs_1["default"].readdirSync("".concat(eventsPath, "/").concat(local)).filter(fileCondition)
                ...
                return __generator(this, function (_c) {
                    var _d;
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, (_d = "../events/".concat(local, "/").concat(fileName), Promise.resolve().then(function () { return require(_d); }))];
                        case 1:
